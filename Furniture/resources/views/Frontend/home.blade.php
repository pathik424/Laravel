...
<div class="banner_section layout_padding">
                ...
                <div class="carousel-item active">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="image_1"><img src="{{ asset('fassets/images/img-1.png') }}"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="about_section layout_padding">
        <div class="container">
            <div class="about_section_2">
                <div class="row">
                    <div class="col-md-6">
                        <div class="image_2"><img src="{{ asset('fassets/images/img-2.png') }}"></div>
                    </div>
                    <div class="col-md-6">
    ...
    <div class="newsletter_section layout_padding">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="imgage_6"><img src="{{ asset('fassets/images/img-6.png') }}"></div>
                </div>
                <div class="col-md-6">

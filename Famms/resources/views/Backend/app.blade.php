...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin_assets/vendors/ti-icons/css/themify-icons.css')}}">
    <link rel="stylesheet" type="{{ asset('admin_assets/text/css')}}" href="js/select.dataTables.min.css">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/admin/myuser"> My Users </a></li>

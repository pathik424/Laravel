...
<div class="col-lg-12 stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <div class="card-body">
            <a href="/admin/add-eyeproduct" class="btn btn-primary mb-4">
                    Add Product
            </a>
            ...
            <tbody>
                ...
                <tr class="table-info">
                    ...
                    <td>
                        ...
                        <td>
                    <a href="{{ url('admin/edit-eyeproduct/' . $products->id) }}" class="btn btn-sm btn-primary">Update</a>
                   <Form action="{{ url('admin/delete-eyeproduct/' . $products->id) }}" method="post">
                    @csrf
                    @method('delete')
